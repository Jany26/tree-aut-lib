...
"""
    Functions implemented over the tree automata
    Basic operations like union, intersection ...

    functinos getNodeFromString() and builtTreeFromString() are used in tests
    - they provide an easy way of generating more complex (structured) trees for test cases
"""
